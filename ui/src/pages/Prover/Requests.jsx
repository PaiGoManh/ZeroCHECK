...
const Requests = () => {
  ...
  return (
    <div className="pt-[5%]">
      <button
        className="w-[250px] h-10 bg-[#00ffec] text-center text-xl font-bold text-black border-white border-[3px] rounded-full
        lg:ml-[40%] mt-5 mb-[4%]"
      >
        scan qrcode
      </button>
      <div className="text-center lg:mt-0 mt-[10%] text-2xl font-bold lg:mb-5">
        REQUESTS PENDING
      </div>
