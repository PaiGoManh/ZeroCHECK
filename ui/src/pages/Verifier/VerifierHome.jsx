    ...
    <div className="">
      <div className="flex flex-col pt-[2%] lg:pl-[40%] pl-[12%]">
        ...
        <input
          ...
          className="w-[300px] h-10 pl-2 border-[#00ffec] border-2 text-black"
        />

        <button
          onClick={handleGenerateQr}
          className="cursor-pointer w-[300px] h-10 bg-[white] text-black  text-center mt-4"
        >
          Generate QR Code
        </button>

        <button className="w-[300px] h-10 bg-[#00ffec] text-xl text-center mt-4 text-black">
          Check
        </button>
      </div>
    </div>
